...
export const INTERNAL_API_KEY = readSecret(process.env.INTERNAL_API_KEY_FILE, process.env.INTERNAL_API_KEY || 'dev-internal-key');
export const SESSION_SECRET = readSecret(process.env.SESSION_SECRET_FILE, process.env.SESSION_SECRET || 'dev-session-secret');
...
export const SAML_CERT = readSecret(process.env.SAML_CERT_PATH, process.env.SAML_CERT || 'replace-me');
