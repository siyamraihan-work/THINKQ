...
TICKETS_SERVICE_URL = os.getenv("TICKETS_SERVICE_URL", "http://tickets-service:3003")
...
INTERNAL_API_KEY = read_secret("INTERNAL_API_KEY_FILE", "INTERNAL_API_KEY", "dev-internal-key")
