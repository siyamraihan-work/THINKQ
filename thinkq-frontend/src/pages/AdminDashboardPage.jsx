              ...
              {analytics ? (
                <div className="analytics-stack">
                  ...
                  <section className="analytics-grid-two">
                    ...
                    <MiniBarChart title="Hourly ticket demand" items={(analytics.hourlyDistribution || []).filter(function(item) { return item.count > 0 })} valueKey="count" labelKey="hour" emptyLabel="No hourly trend data available." />
                  </section>
